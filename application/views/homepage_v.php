                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php foreach ($user_list as $item) { ?>
                            <?php if(md5($item->email) != md5($user->email)) { ?>
                                <li><a target="_blank" href="<?php echo base_url("anasayfa/" . md5($item->email)); ?>"><strong><?php echo $item->full_name; ?></strong> ile oturum aç</a></li>
                            <?php } ?>
                        <?php } ?>

                        <li role="separator" class="divider"></li>
                        <li><a target="_blank" href="<?php echo base_url("giris"); ?>"><strong>Farklı bir hesap</strong> ile oturum aç</a></li>
                        <li role="separator" class="divider"></li>
